    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("food") != null) {
            ...
            if (firebaseAuth != null) {
                ...
                databaseReference.child("foods").child(foodd.getType()).child(foodd.getUid()).addValueEventListener(new ValueEventListener() {
                    @Override
                ...
                databaseReference.child("foods").child(foodd.getType()).child(foodd.getUid()).child("tags").addValueEventListener(new ValueEventListener() {
                    @Override
